...
@RunWith(Cucumber.class)
    @CucumberOptions(
            ...
            monochrome = true,
            tags = "@UpdatePartialEmployeeDetails",

            //@CreatingEmployee or @CheckingCreatedEmployee or @jsonPayloadMethod or @CreatingEmployeeDynamicPayloadMethod or @UpdatingEmployeeDetails or
