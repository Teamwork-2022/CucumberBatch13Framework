...
public class APIPayloadConstants {
    ...
    public static String updatePartialEmployeePayload(){
        JSONObject obj = new JSONObject();
        obj.put("employee_id", APIWorkflowSteps.employee_id);
        obj.put("emp_firstname", "Sohel Jan");
        obj.put("emp_lastname", "Abbasi");
        obj.put("emp_middle_name", "chatting");
        obj.put("emp_gender", "F");
        obj.put("emp_birthday", "1955-08-12");
        obj.put("emp_status", "India Prime Minister");
        obj.put("emp_job_title", "QA President");
        return obj.toString();
    }
